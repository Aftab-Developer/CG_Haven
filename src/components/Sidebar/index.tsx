...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
  <rect x="2" y="3" width="20" height="18" rx="2" ry="2"/>
  <path d="M5 17L9 12L12 17L15 13L19 17"/>
  <circle cx="18" cy="6" r="2"/>
        ...
        label: "Gallery",
        route: "#", 
        children : [{label:"All Gallery", route:"/gallery"}, {label:"Upload", route:"/upload-gallery"}]
      },

      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28" height="18">
          <path fill="none" stroke="white" strokeWidth="2" d="M22 2H2C0.9 2 0 2.9 0 4V16C0 17.1 0.9 18 2 18H4V22L6 18H18L20 22V18H22C23.1 18 24 17.1 24 16V4C24 2.9 23.1 2 22 2ZM12 14C9.79 14 8 12.21 8 10C8 7.79 9.79 6 12 6C14.21 6 16 7.79 16 10C16 12.21 14.21 14 12 14ZM12 8C10.9 8 10 8.9 10 10C10 11.1 10.9 12 12 12C13.1 12 14 11.1 14 10C14 8.9 13.1 8 12 8Z"/>
        </svg>
      ...
      },
      {
        icon: (
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="white" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
              <path d="M6 2H18C18.5523 2 19 2.44772 19 3V21C19 21.5523 18.5523 22 18 22H6C5.44772 22 5 21.5523 5 21V3C5 2.44772 5.44772 2 6 2Z"/>
              <path d="M13 2V12H19"/>
            </svg>
        ...
        route: "#",
        children:[{label:"Home",route:"/home"},{label:"About",route:"/about"},{label:"Contact",route:"/contact"}]
      },
      {
        icon: (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" stroke="white" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  <rect x="3" y="3" width="18" height="18" stroke="white" fill="none"/>
  <path d="M3 7h18" stroke="white"/>
  <path d="M3 11h18" stroke="white"/>
  <path d="M3 15h18" stroke="white"/>
  <path d="M3 19h18" stroke="white"/>
  <path d="M9 3v4h6V3" stroke="white"/>
</svg>
        ...
        route: "#",
        children: [
          { label: "Create Blogs", route: "/create-blogs" },
          { label: "Update Blogs", route: "/update-blogs" },
          { label: "All Blogs", route: "/all-blogs", },
        ],
    ...
    menuItems: [
     ...
     
      {
        ...
        children: [
          ...
          { label: "Types", route: "/type-all" },
          { label: "Items", route: "items-all" },
    ...
    menuItems: [
      {
        ...
        route: "", 
        children:[
          {label:"Create-Category", route:"/create-category"},{label:"Create-Sub-Ca..", route:"/create-sub-category"},{label:"Create Type", route:"/create-type"}
          ,{label:"Create Item", route:"/create-items"}
        ]
      },
    ...
    menuItems: [
      {
        ...
        route: "", 
        children:[
          {label:"Update-Category", route:"/update-category"},{label:"Update-Sub-Ca..", route:"/update-sub-category"},{label:"Update Type", route:"/update-type"}
...

  {
    ...
    menuItems: [
     ...
     
      {
        ...
        label: "Tutorials-Opreations",
        route: "#",
        children: [
          { label: "create-tutorial", route: "" },
          { label: "View Tutorials", route: "" },
    ...
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
          <h1 className="text-2xl -mb-6 font-semibold text-white">Dashboard</h1>
