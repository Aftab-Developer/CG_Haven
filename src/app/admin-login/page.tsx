...
import { AdminSchema } from "@/validatorModels/loginValidatorSchema";
...
const SignIn = () => {  
  ...
  const submitHandler = async () => {
    try {  
      const res = AdminSchema.safeParse({ad_name: loginForm.ad_name,
        ad_email: loginForm.ad_email ,ad_password:loginForm.ad_password} );
      if (!res.success) {
      ...
      console.log(data)
      if(data.success) {
        window.location.href = `/verify-admin?email=${loginForm.ad_email}`;
...
<div className="rounded-sm min-h-screen border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
  ...
  <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
      <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
        <span className="mb-1.5 block font-medium">Change the Web</span>
        ...
        <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                onChange={(e) => setLoginForm({...loginForm,ad_name:e.target.value})}
              />
...
>
  <text x="2" y="20" fontFamily="Arial" fontSize="20" fill="currentColor">N</text>
</svg>
          ...
          <div className="mb-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" 
                onChange={(e) => setLoginForm({...loginForm,ad_email:e.target.value})}
              />
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                onChange={(e) => setLoginForm({...loginForm,ad_password:e.target.value})}
              />
          ...
          <div className="mb-5">
             ...
             <div
            className="w-full flex justify-center items-center text-center cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
            onClick={() => submitHandler()}
          > {
            loading ? <><LoaderCircle className="w-6 h-6 mr-3 text-center text-white animate-spin" />  loading</>: "Sign In"
          }
          </div>
